    ...
    <div className="flex flex-col gap-6 max-w-7xl mx-auto">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-2.5">
          <button className="px-3.5 py-2 rounded-xl text-xs font-semibold border border-slate-300 dark:border-slate-800 bg-white dark:bg-[#0d1017] hover:bg-slate-50 dark:hover:bg-slate-800/60 text-slate-700 dark:text-slate-200 transition-all flex items-center gap-2 cursor-pointer shadow-sm">
            <Download className="w-3.5 h-3.5" />
            <span>Ekspor Data</span>
          </button>
          <button className="px-4 py-2 rounded-xl text-xs font-bold bg-sky-500 hover:bg-sky-400 text-white dark:text-slate-950 transition-all flex items-center gap-2 cursor-pointer shadow-md shadow-sky-500/20">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3.5">
        {/* Card 1: Total Aset */}
        <div className="p-4 rounded-xl bg-white dark:bg-gradient-to-b dark:from-[#0f141f] dark:to-[#0a0d14] border border-slate-200 dark:border-slate-800/80 shadow-sm dark:shadow-lg dark:shadow-black/30 flex flex-col justify-between transition-all">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <div className="relative p-5 rounded-2xl bg-gradient-to-br from-sky-50 via-white to-sky-50/30 dark:from-[#0c1424] dark:via-[#090d16] dark:to-[#06090e] border border-sky-200 dark:border-sky-500/30 shadow-md dark:shadow-xl dark:shadow-sky-950/20 overflow-hidden">
        ...
        <div className="relative p-5 rounded-2xl bg-gradient-to-br from-rose-50 via-white to-rose-50/30 dark:from-[#1a0f14] dark:via-[#120a0e] dark:to-[#080507] border border-rose-200 dark:border-rose-500/30 shadow-md dark:shadow-xl dark:shadow-rose-950/20 overflow-hidden">
        ...
        <div className="relative p-5 rounded-2xl bg-gradient-to-br from-emerald-50 via-white to-emerald-50/30 dark:from-[#0c1c17] dark:via-[#091310] dark:to-[#050b09] border border-emerald-200 dark:border-emerald-500/30 shadow-md dark:shadow-xl dark:shadow-emerald-950/20 overflow-hidden">
      ...
      <div className="p-4 rounded-2xl bg-white dark:bg-[#0d1017] border border-slate-200 dark:border-slate-800 shadow-sm dark:shadow-xl dark:shadow-black/40">
        ...
        <div className="flex flex-col gap-2">
          {[
            ...
            <div
              key={i}
              className="px-4 py-2.5 rounded-xl bg-slate-50 dark:bg-[#090c12] border border-slate-200/80 dark:border-slate-800/80 flex items-center justify-between hover:border-slate-300 dark:hover:border-slate-700/80 transition-colors"
            >
        ...
        <div className="p-4 rounded-2xl bg-white dark:bg-[#0d1017] border border-slate-200 dark:border-slate-800 shadow-sm dark:shadow-xl dark:shadow-black/40">
          ...
          <div className="flex flex-col gap-2.5 text-xs">
            {[
              ...
              <div key={idx} className="flex items-center justify-between p-2 rounded-lg bg-slate-50 dark:bg-[#090c12] border border-slate-200 dark:border-slate-800/60">
